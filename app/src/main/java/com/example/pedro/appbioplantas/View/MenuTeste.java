...
public class MenuTeste extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fabNovaChave);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.menuMinhasChaves) {

        } else if (id == R.id.menuNovaChave) {

        } else if (id == R.id.menuGerarPIN) {

        } else if (id == R.id.menuGuia) {

        } else if (id == R.id.menuGlossario) {

        } else if (id == R.id.menuPerfil) {
            /*FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.replace(R.id.framePerfil, new PerfilFragment());
